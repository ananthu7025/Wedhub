...
import { platformSettingAdminRouter } from "../modules/platform-settings";
...
apiV1Router.use("/admin/settings", platformSettingAdminRouter);
...
apiV1Router.use("/admin/gallery-categories", galleryCategoriesAdminRouter);
...
apiV1Router.use("/vendor-quotations", vendorQuotationRouter);
