...
export async function searchVendors(
  ...
  const filters = {
    ...
    catalogPriceMin: query.catalogPriceMin,
    catalogPriceMax: query.catalogPriceMax,
    ...
    try {
      await searchRepository.createSearchLog({
        ...
        filters: {
          ...
          catalogPriceMin: query.catalogPriceMin ?? null,
          catalogPriceMax: query.catalogPriceMax ?? null,
