...
//     domain (replaced the R2-default pub-*.r2.dev hostname once this
//     domain was added as an R2 custom domain — 2026-09-17), same origin
//     already allowed in images.remotePatterns.
  ...
  images: {
    remotePatterns: [
      ...
      },
      {
        ...
        // getPublicMediaUrl(). Replaced the R2-default pub-*.r2.dev
        // hostname on 2026-09-17 once this custom domain was added.
      },
    ],
