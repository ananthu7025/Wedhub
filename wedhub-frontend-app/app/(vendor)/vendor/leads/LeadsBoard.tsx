                ...
                <div className="rounded-xl border border-border bg-white p-4 sm:p-6">
                  <div className="mb-4.5 flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div className="flex flex-shrink-0 gap-2">
                      ...
                      <Link
                        href={`/vendor/quotations/new?leadId=${detail.id}`}
                        className="inline-flex items-center gap-1.5 rounded-lg bg-brand-primary px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-brand-primary-hover shadow-xs"
                      >
