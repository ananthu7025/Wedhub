    ...
    <div className="row">
      <div className="col-lg-4">
        <div className="logo-head-wrap side-head-wrap mb-0">
          <a href="additional-info.hmtl.html" className="mb-3">
            <svg
              width={24}
              height={24}
              viewBox="0 0 24 24"
      ...
      <div className="col-lg-4">
        <form id="">
          <div className="step ">
            ...
            <div className="input-group mb-3">
              <textarea
                ...
                defaultValue={""}
              />
              <label htmlFor="package-desc" className="form-label">
                Package Description
              </label>
            </div>
            <div className="input-group mb-3 mt-1">
              <input
                ...
                placeholder=" "
              />
              <label htmlFor="package-pricing" className="form-label">
                Package Price
              </label>
            </div>
            <div className="input-group mb-3">
          ...
          <div className="skip-sec">
            <a href="profile-successpage.html">
