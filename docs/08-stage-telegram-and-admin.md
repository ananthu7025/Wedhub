...
- [ ] Email abstraction + provider, notification preferences, template system
- [ ] Queue notifications, retry policy, dead-letter/failure handling, notification history
...
- A failed notification does not fail the core transaction it was queued from; retries are safe; user/vendor preferences are respected.
