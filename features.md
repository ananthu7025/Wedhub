...
| 🔥 **P0** | **Business Services Hub**      | Sell GST/business setup, branding, websites and digital marketing through your partners |
| **P1**    | **Payment/Advance Reminders**  | Automatically remind vendors about pending advance/balance payments                     |
| **P1**    | **Digital Contracts**          | Vendor terms, scope, cancellation policy and couple acceptance                          |
| **P1**    | **Review Automation**          | After wedding completion → automatically request a review                               |
| **P1**    | **Business Dashboard**         | Enquiries → quotes → bookings → revenue → conversion rate                               |
